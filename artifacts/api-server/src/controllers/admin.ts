...
export const getDailyReport = async (req: Request, res: Response) => {
  try {
    ...
    const platformFeePaise = Math.round(grossRevenuePaise * PLATFORM_FEE_PERCENT);
    ...
    logger.error({ error }, "getDailyReport error");
...
export const getAllVendors = async (req: Request, res: Response) => {
  try {
    ...
    logger.error({ error }, "getAllVendors error");
...
export const getAllOrders = async (req: Request, res: Response) => {
  try {
    ...
    logger.error({ error }, "getAllOrders error");
