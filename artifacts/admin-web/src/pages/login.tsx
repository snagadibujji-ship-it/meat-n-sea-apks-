    ...
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-muted-foreground mt-1">Meat n Sea</p>
        </div>
          ...
          {step === "phone" ? (
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-4">
              <div>
                ...
                {devOtp && (
                  <div className="mb-3 px-3 py-2 rounded-lg bg-yellow-50 border border-yellow-200 text-xs text-yellow-800 font-mono dark:bg-yellow-950 dark:border-yellow-900 dark:text-yellow-200">
